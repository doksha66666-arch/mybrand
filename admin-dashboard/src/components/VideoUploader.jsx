...
export default function VideoUploader({ value, onChange }) {
  ...
  return (
    <div style={{ marginTop: 10 }}>
      ...
      {value && <button type="button" onClick={() => onChange('')} style={{ marginTop: 7, border: 0, background: 'transparent', color: '#DC2626', fontSize: 12, cursor: 'pointer' }}>إزالة الفيديو</button>}
    </div>
  );
}
