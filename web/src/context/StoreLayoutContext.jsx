...
export function StoreLayoutProvider({ children }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .home-reference,.categories-reference,.product-reference,.cart-reference,.checkout-reference,.orders-reference,.wishlist-reference,.account-reference,.new-arrivals-page,.offers-page,.trend-app,.mybrand-live,.tracking-app,.register-app,.app{--store-radius-local:var(--store-radius-raw);background:var(--store-bg-raw)!important;color:var(--store-text-raw)}
      ...
      .home-reference .app,.categories-reference .categories-app,.product-reference .product-app,.checkout-app,.orders-page,.wishlist-app,.account-page,.new-arrivals-page,.offers-page,.trend-app,.mybrand-live,.tracking-app{max-width:var(--store-content-width-raw)}
