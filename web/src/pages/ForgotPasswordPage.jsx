...
export default function ForgotPasswordPage() {
  ...
  React.useEffect(() => {
    try {
      if (returnTo && returnTo.startsWith('/')) localStorage.setItem('mybrand_reset_return', JSON.stringify({ returnTo, checkoutState: returnState || null }));
      else localStorage.removeItem('mybrand_reset_return');
    } catch (_) {}
